      ...
      <div className="activities-card">
        ...
        <div className="chart">
          <div className="parent">
            ...
            <img className="line-5-stroke" alt="" src="/line-5-stroke.svg" />
          </div>
          <div className="group">
            <div className="div">300</div>
            <img className="line-5-stroke" alt="" src="/line-5-stroke1.svg" />
          </div>
          ...
          <div className="parent2">
            ...
            <img className="line-5-stroke5" alt="" src="/line-5-stroke1.svg" />
          </div>
        </div>
